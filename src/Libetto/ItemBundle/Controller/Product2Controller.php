...
use Libetto\ItemBundle\Form\ProductType;
...
class Product2Controller extends Controller
{
     ...
     *
     * @Route("/", name="product2_create")
     * @Method("POST")
     * @Template("LibettoItemBundle:Product:new.html.twig")
     */
     ...
     *
     * @Route("/{id}/edit", name="product2_edit")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/{id}", name="product2_update")
     * @Method("PUT")
     * @Template("LibettoItemBundle:Product:edit.html.twig")
     */
